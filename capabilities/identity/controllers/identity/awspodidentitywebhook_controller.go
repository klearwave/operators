...
import (
	...
	"github.com/klearwave/operators-capability/capabilities/identity/apis/identity/v1alpha1/awspodidentitywebhook"
	"github.com/klearwave/operators-capability/capabilities/identity/internal/dependencies"
	"github.com/klearwave/operators-capability/capabilities/identity/internal/mutate"
)
...
// +kubebuilder:rbac:groups=identity.platform.klearwave.io,resources=awspodidentitywebhooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=identity.platform.klearwave.io,resources=awspodidentitywebhooks/status,verbs=get;update;patch

...
// MutateDeploymentKlearwaveIdentitySystemAwsPodIdentityWebhook mutates the Deployment resource with name aws-pod-identity-webhook.
func MutateDeploymentKlearwaveIdentitySystemAwsPodIdentityWebhook(

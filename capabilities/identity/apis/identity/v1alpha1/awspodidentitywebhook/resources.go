...
const sampleAWSPodIdentityWebhook = `apiVersion: identity.platform.klearwave.io/v1alpha1
...
const sampleAWSPodIdentityWebhookRequired = `apiVersion: identity.platform.klearwave.io/v1alpha1
kind: AWSPodIdentityWebhook
metadata:
  name: awspodidentitywebhook-sample
spec:
...
var CreateFuncs = []func(
	...
	*workload.Request,
	...
	CreateDeploymentKlearwaveIdentitySystemAwsPodIdentityWebhook,

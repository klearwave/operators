...
type AWSPodIdentityWebhookSpec struct {
	...
	// +kubebuilder:default="klearwave-identity-system"
	...
	// +kubebuilder:validation:Optional
	Webhook AWSPodIdentityWebhookSpecWebhook `json:"webhook,omitempty"`
}

type AWSPodIdentityWebhookSpecWebhook struct {
	// +kubebuilder:default="amazon/amazon-eks-pod-identity-webhook:v0.6.7"
	// +kubebuilder:validation:Optional
	...
	// +kubebuilder:validation:Optional
	Resources AWSPodIdentityWebhookSpecWebhookResources `json:"resources,omitempty"`
}

type AWSPodIdentityWebhookSpecWebhookResources struct {
	// +kubebuilder:validation:Optional
	Requests AWSPodIdentityWebhookSpecWebhookResourcesRequests `json:"requests,omitempty"`

	// +kubebuilder:validation:Optional
	Limits AWSPodIdentityWebhookSpecWebhookResourcesLimits `json:"limits,omitempty"`
}

type AWSPodIdentityWebhookSpecWebhookResourcesRequests struct {
...
type AWSPodIdentityWebhookSpecWebhookResourcesLimits struct {

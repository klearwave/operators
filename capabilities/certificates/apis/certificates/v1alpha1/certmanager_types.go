...
type CertManagerSpec struct {
	...
	// +kubebuilder:default="klearwave-certificates-system"
...
type CertManagerSpecInjector struct {
	// +kubebuilder:default="quay.io/jetstack/cert-manager-cainjector:v1.17.2"
	// +kubebuilder:validation:Optional
...
type CertManagerSpecController struct {
	// +kubebuilder:default="quay.io/jetstack/cert-manager-controller:v1.17.2"
	// +kubebuilder:validation:Optional
...
type CertManagerSpecWebhook struct {
	// +kubebuilder:default="quay.io/jetstack/cert-manager-webhook:v1.17.2"
	// +kubebuilder:validation:Optional

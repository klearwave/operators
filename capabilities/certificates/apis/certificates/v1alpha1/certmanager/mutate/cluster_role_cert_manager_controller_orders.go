...
// MutateClusterRoleCertManagerControllerOrders mutates the ClusterRole resource with name cert-manager-controller-orders.
func MutateClusterRoleCertManagerControllerOrders(

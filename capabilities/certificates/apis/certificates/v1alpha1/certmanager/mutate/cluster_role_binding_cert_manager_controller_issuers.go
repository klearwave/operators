...
// MutateClusterRoleBindingCertManagerControllerIssuers mutates the ClusterRoleBinding resource with name cert-manager-controller-issuers.
func MutateClusterRoleBindingCertManagerControllerIssuers(

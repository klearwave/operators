...
// MutateClusterRoleCertManagerControllerChallenges mutates the ClusterRole resource with name cert-manager-controller-challenges.
func MutateClusterRoleCertManagerControllerChallenges(

...
// MutateRoleBindingNamespaceCertManagerCertManagerTokenrequest mutates the RoleBinding resource with name cert-manager-cert-manager-tokenrequest.
func MutateRoleBindingNamespaceCertManagerCertManagerTokenrequest(

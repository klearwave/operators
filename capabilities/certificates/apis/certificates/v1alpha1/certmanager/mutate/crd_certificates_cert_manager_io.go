...
// MutateCRDCertificatesCertManagerIo mutates the CustomResourceDefinition resource with name certificates.cert-manager.io.
func MutateCRDCertificatesCertManagerIo(

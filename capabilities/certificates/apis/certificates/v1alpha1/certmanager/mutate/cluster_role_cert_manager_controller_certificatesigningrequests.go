...
// MutateClusterRoleCertManagerControllerCertificatesigningrequests mutates the ClusterRole resource with name cert-manager-controller-certificatesigningrequests.
func MutateClusterRoleCertManagerControllerCertificatesigningrequests(

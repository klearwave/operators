...
// MutateRoleNamespaceCertManagerCainjectorLeaderelection mutates the Role resource with name cert-manager-cainjector:leaderelection.
func MutateRoleNamespaceCertManagerCainjectorLeaderelection(

...
// MutateClusterRoleBindingCertManagerControllerIngressShim mutates the ClusterRoleBinding resource with name cert-manager-controller-ingress-shim.
func MutateClusterRoleBindingCertManagerControllerIngressShim(

...
// MutateDeploymentNamespaceCertManagerWebhook mutates the Deployment resource with name cert-manager-webhook.
func MutateDeploymentNamespaceCertManagerWebhook(

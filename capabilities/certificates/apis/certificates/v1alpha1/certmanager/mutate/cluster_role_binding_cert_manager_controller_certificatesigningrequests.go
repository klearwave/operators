...
// MutateClusterRoleBindingCertManagerControllerCertificatesigningrequests mutates the ClusterRoleBinding resource with name cert-manager-controller-certificatesigningrequests.
func MutateClusterRoleBindingCertManagerControllerCertificatesigningrequests(

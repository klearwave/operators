...
// MutateClusterRoleBindingCertManagerControllerCertificates mutates the ClusterRoleBinding resource with name cert-manager-controller-certificates.
func MutateClusterRoleBindingCertManagerControllerCertificates(

...
// MutateClusterRoleBindingCertManagerControllerApproveCertManagerIo mutates the ClusterRoleBinding resource with name cert-manager-controller-approve:cert-manager-io.
func MutateClusterRoleBindingCertManagerControllerApproveCertManagerIo(

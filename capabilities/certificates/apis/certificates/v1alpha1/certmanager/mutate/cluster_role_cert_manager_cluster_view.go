...
// MutateClusterRoleCertManagerClusterView mutates the ClusterRole resource with name cert-manager-cluster-view.
func MutateClusterRoleCertManagerClusterView(

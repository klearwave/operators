...
// MutateDeploymentNamespaceCertManagerCainjector mutates the Deployment resource with name cert-manager-cainjector.
func MutateDeploymentNamespaceCertManagerCainjector(

...
// MutateCRDChallengesAcmeCertManagerIo mutates the CustomResourceDefinition resource with name challenges.acme.cert-manager.io.
func MutateCRDChallengesAcmeCertManagerIo(

...
// MutateRoleBindingNamespaceCertManagerWebhookDynamicServing mutates the RoleBinding resource with name cert-manager-webhook:dynamic-serving.
func MutateRoleBindingNamespaceCertManagerWebhookDynamicServing(

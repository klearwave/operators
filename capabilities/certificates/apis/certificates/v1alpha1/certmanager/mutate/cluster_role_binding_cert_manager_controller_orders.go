...
// MutateClusterRoleBindingCertManagerControllerOrders mutates the ClusterRoleBinding resource with name cert-manager-controller-orders.
func MutateClusterRoleBindingCertManagerControllerOrders(

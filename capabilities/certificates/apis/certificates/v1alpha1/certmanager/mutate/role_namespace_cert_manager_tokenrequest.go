...
// MutateRoleNamespaceCertManagerTokenrequest mutates the Role resource with name cert-manager-tokenrequest.
func MutateRoleNamespaceCertManagerTokenrequest(

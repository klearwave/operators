...
// MutateClusterRoleBindingCertManagerWebhookSubjectaccessreviews mutates the ClusterRoleBinding resource with name cert-manager-webhook:subjectaccessreviews.
func MutateClusterRoleBindingCertManagerWebhookSubjectaccessreviews(

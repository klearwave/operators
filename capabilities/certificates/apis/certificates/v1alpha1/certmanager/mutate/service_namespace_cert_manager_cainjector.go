...
// MutateServiceNamespaceCertManagerCainjector mutates the Service resource with name cert-manager-cainjector.
func MutateServiceNamespaceCertManagerCainjector(

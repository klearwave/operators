...
// MutateRoleBindingNamespaceCertManagerLeaderelection mutates the RoleBinding resource with name cert-manager:leaderelection.
func MutateRoleBindingNamespaceCertManagerLeaderelection(

...
// MutateRoleNamespaceCertManagerLeaderelection mutates the Role resource with name cert-manager:leaderelection.
func MutateRoleNamespaceCertManagerLeaderelection(

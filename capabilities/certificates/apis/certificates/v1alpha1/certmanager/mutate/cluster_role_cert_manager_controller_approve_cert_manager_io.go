...
// MutateClusterRoleCertManagerControllerApproveCertManagerIo mutates the ClusterRole resource with name cert-manager-controller-approve:cert-manager-io.
func MutateClusterRoleCertManagerControllerApproveCertManagerIo(

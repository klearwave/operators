...
// MutateRoleBindingNamespaceCertManagerCainjectorLeaderelection mutates the RoleBinding resource with name cert-manager-cainjector:leaderelection.
func MutateRoleBindingNamespaceCertManagerCainjectorLeaderelection(

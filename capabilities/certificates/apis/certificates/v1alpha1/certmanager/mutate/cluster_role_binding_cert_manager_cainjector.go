...
// MutateClusterRoleBindingCertManagerCainjector mutates the ClusterRoleBinding resource with name cert-manager-cainjector.
func MutateClusterRoleBindingCertManagerCainjector(

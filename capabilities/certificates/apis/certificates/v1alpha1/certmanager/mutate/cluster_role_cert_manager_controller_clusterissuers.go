...
// MutateClusterRoleCertManagerControllerClusterissuers mutates the ClusterRole resource with name cert-manager-controller-clusterissuers.
func MutateClusterRoleCertManagerControllerClusterissuers(

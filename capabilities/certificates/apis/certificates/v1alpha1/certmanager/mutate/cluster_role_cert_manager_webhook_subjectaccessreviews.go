...
// MutateClusterRoleCertManagerWebhookSubjectaccessreviews mutates the ClusterRole resource with name cert-manager-webhook:subjectaccessreviews.
func MutateClusterRoleCertManagerWebhookSubjectaccessreviews(

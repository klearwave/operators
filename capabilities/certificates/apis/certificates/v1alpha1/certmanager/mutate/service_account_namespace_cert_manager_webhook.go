...
// MutateServiceAccountNamespaceCertManagerWebhook mutates the ServiceAccount resource with name cert-manager-webhook.
func MutateServiceAccountNamespaceCertManagerWebhook(

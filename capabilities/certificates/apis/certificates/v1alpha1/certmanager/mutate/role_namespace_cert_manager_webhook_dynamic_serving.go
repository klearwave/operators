...
// MutateRoleNamespaceCertManagerWebhookDynamicServing mutates the Role resource with name cert-manager-webhook:dynamic-serving.
func MutateRoleNamespaceCertManagerWebhookDynamicServing(

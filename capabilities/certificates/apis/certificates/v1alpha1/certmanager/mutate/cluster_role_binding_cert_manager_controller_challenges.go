...
// MutateClusterRoleBindingCertManagerControllerChallenges mutates the ClusterRoleBinding resource with name cert-manager-controller-challenges.
func MutateClusterRoleBindingCertManagerControllerChallenges(

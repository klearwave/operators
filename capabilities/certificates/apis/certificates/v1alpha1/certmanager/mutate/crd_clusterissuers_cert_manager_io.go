...
// MutateCRDClusterissuersCertManagerIo mutates the CustomResourceDefinition resource with name clusterissuers.cert-manager.io.
func MutateCRDClusterissuersCertManagerIo(

...
// MutateCRDCertificaterequestsCertManagerIo mutates the CustomResourceDefinition resource with name certificaterequests.cert-manager.io.
func MutateCRDCertificaterequestsCertManagerIo(

...
// MutateClusterRoleBindingCertManagerControllerClusterissuers mutates the ClusterRoleBinding resource with name cert-manager-controller-clusterissuers.
func MutateClusterRoleBindingCertManagerControllerClusterissuers(

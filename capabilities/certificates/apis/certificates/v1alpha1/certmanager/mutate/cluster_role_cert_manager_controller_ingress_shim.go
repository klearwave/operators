...
// MutateClusterRoleCertManagerControllerIngressShim mutates the ClusterRole resource with name cert-manager-controller-ingress-shim.
func MutateClusterRoleCertManagerControllerIngressShim(

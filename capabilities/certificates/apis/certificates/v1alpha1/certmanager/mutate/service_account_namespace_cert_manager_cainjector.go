...
// MutateServiceAccountNamespaceCertManagerCainjector mutates the ServiceAccount resource with name cert-manager-cainjector.
func MutateServiceAccountNamespaceCertManagerCainjector(

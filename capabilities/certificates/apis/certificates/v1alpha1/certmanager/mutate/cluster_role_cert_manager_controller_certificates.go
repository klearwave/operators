...
// MutateClusterRoleCertManagerControllerCertificates mutates the ClusterRole resource with name cert-manager-controller-certificates.
func MutateClusterRoleCertManagerControllerCertificates(

...
// MutateCRDOrdersAcmeCertManagerIo mutates the CustomResourceDefinition resource with name orders.acme.cert-manager.io.
func MutateCRDOrdersAcmeCertManagerIo(

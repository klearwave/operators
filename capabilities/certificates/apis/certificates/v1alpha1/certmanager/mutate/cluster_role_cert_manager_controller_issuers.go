...
// MutateClusterRoleCertManagerControllerIssuers mutates the ClusterRole resource with name cert-manager-controller-issuers.
func MutateClusterRoleCertManagerControllerIssuers(

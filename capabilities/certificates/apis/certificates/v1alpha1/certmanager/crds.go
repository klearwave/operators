...
used to influence garbage collection and back-off.`,
	...
	return mutate.MutateCRDCertificaterequestsCertManagerIo(resourceObj, parent, reconciler, req)
}
...
Cannot be set if the ` + "`" + `subject` + "`" + ` or ` + "`" + `commonName` + "`" + ` field is set.`,
											...
											"nameConstraints": map[string]interface{}{
...
of information appearing in the permitted`,
														"type": "object",
														"properties": map[string]interface{}{
															"dnsDomains": map[string]interface{}{
...
This should be a valid CIDR notation.`,
															...
															"uriDomains": map[string]interface{}{
...
This should be a valid CIDR notation.`,
											...
											"otherNames": map[string]interface{}{
...
example, "1.2.840.113556.1.4.221".`,
														...
														"utf8Value": map[string]interface{}{
...
Cannot be set if the ` + "`" + `renewBeforePercentage` + "`" + ` field is set.`,
											...
											"renewBeforePercentage": map[string]interface{}{
...
field.`,
	...
	return mutate.MutateCRDCertificatesCertManagerIo(resourceObj, parent, reconciler, req)
}
...
operator is "In", and the values array contains only "value". The requirements are ANDed.`,
																														...
																														"matchLabelKeys": map[string]interface{}{
...
This is a beta field and requires enabling MatchLabelKeysInPodAffinity feature gate (enabled by default).`,
																														...
																														"mismatchLabelKeys": map[string]interface{}{
...
Note that this field cannot be set when spec.os.name is windows.`,
																							...
																							"fsGroupChangePolicy": map[string]interface{}{
...
Note that this field cannot be set when spec.os.name is windows.`,
																							...
																							"runAsNonRoot": map[string]interface{}{
...
Note that this field cannot be set when spec.os.name is windows.`,
																								...
																								"properties": map[string]interface{}{
																									"localhostProfile": map[string]interface{}{
...
If not set, the state of the challenge is unknown.`,
	...
	return mutate.MutateCRDChallengesAcmeCertManagerIo(resourceObj, parent, reconciler, req)
}
...
If not set, certificates will be issued without distribution points set.`,
													...
													"issuingCertificateURLs": map[string]interface{}{
...
the cert-manager controller container is used to validate the TLS connection.`,
													...
													"caBundleSecretRef": map[string]interface{}{
...
More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names`,
													...
													"clientCertSecretRef": map[string]interface{}{
...
More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names`,
													...
													"clientKeySecretRef": map[string]interface{}{
...
server to issue certificates.`,
												"type": "object",
												"properties": map[string]interface{}{
													"lastPrivateKeyHash": map[string]interface{}{
...
transition.`,
	...
	return mutate.MutateCRDClusterissuersCertManagerIo(resourceObj, parent, reconciler, req)
}
...
transition.`,
	...
	return mutate.MutateCRDIssuersCertManagerIo(resourceObj, parent, reconciler, req)
}
...
This field will be immutable after it is initially set.`,
	...
	return mutate.MutateCRDOrdersAcmeCertManagerIo(resourceObj, parent, reconciler, req)
}

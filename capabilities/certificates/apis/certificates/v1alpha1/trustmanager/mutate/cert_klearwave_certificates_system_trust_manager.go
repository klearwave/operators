...
// MutateCertKlearwaveCertificatesSystemTrustManager mutates the Certificate resource with name trust-manager.
func MutateCertKlearwaveCertificatesSystemTrustManager(

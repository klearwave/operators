...
// MutateRoleBindingNamespaceTrustManagerLeaderelection mutates the RoleBinding resource with name trust-manager:leaderelection.
func MutateRoleBindingNamespaceTrustManagerLeaderelection(

...
// MutateRoleNamespaceTrustManagerLeaderelection mutates the Role resource with name trust-manager:leaderelection.
func MutateRoleNamespaceTrustManagerLeaderelection(

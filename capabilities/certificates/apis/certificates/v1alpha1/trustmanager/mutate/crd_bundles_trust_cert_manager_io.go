...
// MutateCRDBundlesTrustCertManagerIo mutates the CustomResourceDefinition resource with name bundles.trust.cert-manager.io.
func MutateCRDBundlesTrustCertManagerIo(

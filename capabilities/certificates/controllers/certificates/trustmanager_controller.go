...
import (
	...
	"github.com/klearwave/operators-capability/capabilities/certificates/internal/dependencies"
	"github.com/klearwave/operators-capability/capabilities/certificates/internal/mutate"
)
...
func NewTrustManagerReconciler(mgr ctrl.Manager) *TrustManagerReconciler {
	return &TrustManagerReconciler{
		Name:         "TrustManager",
		Client:       mgr.GetClient(),
		Events:       mgr.GetEventRecorderFor("TrustManager-Controller"),
		FieldManager: "TrustManager-reconciler",
		Log:          ctrl.Log.WithName("controllers").WithName("certificates").WithName("TrustManager"),
		Watches:      []client.Object{},
		Phases:       &phases.Registry{},
		Manager:      mgr,
	}
...
// +kubebuilder:rbac:groups=certificates.platform.klearwave.io,resources=trustmanagers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=certificates.platform.klearwave.io,resources=trustmanagers/status,verbs=get;update;patch
...
func (r *TrustManagerReconciler) NewRequest(ctx context.Context, request ctrl.Request) (*workload.Request, error) {
	component := &certificatesv1alpha1.TrustManager{}
...
func (r *TrustManagerReconciler) GetResources(req *workload.Request) ([]client.Object, error) {
	component, err := trustmanager.ConvertWorkload(req.Workload)
	if err != nil {
		return nil, err
	}

	return trustmanager.Generate(*component, r, req)
}
...
func (r *TrustManagerReconciler) CheckReady(req *workload.Request) (bool, error) {
	return dependencies.TrustManagerCheckReady(r, req)
}
...
func (r *TrustManagerReconciler) Mutate(
	req *workload.Request,
	object client.Object,
) ([]client.Object, bool, error) {
	return mutate.TrustManagerMutate(r, req, object)
}
...
func (r *TrustManagerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	baseController, err := ctrl.NewControllerManagedBy(mgr).
		...
		For(&certificatesv1alpha1.TrustManager{}).
		Build(r)
	if err != nil {

...
import (
	...
	certificatescontrollers "github.com/klearwave/operators-capability/capabilities/certificates/controllers/certificates"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4eca7f19.platform.klearwave.io",
